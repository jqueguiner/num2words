...
class Num2Word_MS():
    ...
    def puluh(self, number):
        # it is used to spell tens and units
        if number[0] == '1':
            if number[1] == '0':
                return ['sepuluh']
            elif number[1] == '1':
    ...
    def to_ordinal(self, number):
        ...
        # Special cases for Malay ordinals
        if out_word == "satu":
            return "pertama"
        elif out_word == "dua":
            return "kedua"
            ...
            return "ketiga"
        elif out_word.startswith("empat"):
            return "ke" + out_word
        elif out_word.startswith("lima"):
            return "ke" + out_word
        else:
            return "ke" + out_word
    ...
    def to_currency(self, value):
        return self.to_cardinal(value) + " ringgit"
