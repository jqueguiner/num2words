...
SCALE = {
    ...
    3: ('bilijan', 'bilijarde', 'bilijardi', False),  # 10^9
    4: ('trilijan', 'trilijarde', 'trilijardi', False),  # 10^12
    5: ('kvadrilijan', 'kvadrilijarde', 'kvadrilijardi', False),  # 10^15
    6: ('kvintilijan', 'kvintilijarde', 'kvintilijardi', False),  # 10^18
    7: ('sekstilijan', 'sekstilijarde', 'sekstilijardi', False),  # 10^21
    8: ('septilijan', 'septilijarde', 'septilijardi', False),  # 10^24
    9: ('oktilijan', 'oktilijarde', 'oktilijardi', False),  # 10^27
    10: ('nonilijan', 'nonilijarde', 'nonilijardi', False),  # 10^30
}
...
class Num2Word_HR(Num2Word_Base):
    ...
    def pluralize(self, number, forms):
        ...
        - 2, 3, 4: paucal (genitive singular)
        - 5+: plural (genitive plural)
        - But 11, 12, 13, 14: plural (genitive plural)
        """
