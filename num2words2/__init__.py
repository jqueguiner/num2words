...
def num2words_sentence(*args, **kwargs):
    from .converters.sentence import num2words_sentence as sentence_converter

    return sentence_converter(*args, **kwargs)


def sentence_to_words(*args, **kwargs):
    from .converters.sentence import sentence_to_words as sentence_converter

    return sentence_converter(*args, **kwargs)


def convert_sentence(*args, **kwargs):
    from .converters.sentence import convert_sentence as sentence_converter
